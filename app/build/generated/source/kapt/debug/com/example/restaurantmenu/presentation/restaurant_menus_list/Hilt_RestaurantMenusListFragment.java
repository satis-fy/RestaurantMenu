 ...
 */
public abstract class Hilt_RestaurantMenusListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RestaurantMenusListFragment() {
    super();
  }

  Hilt_RestaurantMenusListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestaurantMenusListFragment_GeneratedInjector) this.generatedComponent()).injectRestaurantMenusListFragment(UnsafeCasts.<RestaurantMenusListFragment>unsafeCast(this));
    }
  }
